...
intervals = \
    {
        'metro': [75, 60], # интервал движения поездов метро ||| 300
        'trolleybus': [140, 120], # интервал движения городских троллейбусов ||| 600
        'train': [260, 240], # интервал движения поездов бизнес-класса ||| 1200
        'bus': [320, 300], # интервал движения междугородных автобусов ||| 1200
        'plane': [1820, 1800],  # интервал движения самолётов ||| 3600
        'taxi': [100, 90], # интервал движения пригородных маршрутных такси ||| 900
        'citylines': [75, 60],  # интервал движения поездов городских линий ||| 600
        'regtrain': [45, 25], # интервал движения поездов экономкласса ||| 90
        'tram': [40, 20] # интервал движения трамваев в г. Ридиполь ||| 60
    }  
