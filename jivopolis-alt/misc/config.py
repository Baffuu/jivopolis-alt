...
walks = [45, 60, 90, 45, 75, 60, 0, 0, 0, 0, 0, 0]  # продолжительность ходьбы #todo insert into walk
limeteds = [
...
locations = [
    [
        ...
        '✈ Нац. аэропорт', '✈ Старый аэропорт', '🚆 Центральный вокзал',
...
locations[2] = [
    ...
    'Национальный аэропорт', 'Старый аэропорт', 'Вокзальная', 'Александровская',
