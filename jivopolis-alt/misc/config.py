...
WALK = [  # список мест, в которые можно добраться пешком
    [
        ...
        'Зелёный луг', 'Максиград'
    ],
    [
        'Аэродромная', 'Котай-Главный', 'Александровская', 'Рынок',
        'Старокотайский ФАП', 'Агрогородок Красный', 'Автовокзал Жабинка',
        'Максиград', 'Феликс', 'Георгиевск', 'Жабинка (больница)', 'Центральная площадь Максиграда'
    ],
    [
        '', '', '', 'Админская улица', '', '', 'Средняя школа Жабинки', '', '', '',
        'Посёлок Пень', ''
    ],
    [  # время, требуемое для ходьбы
        45, 60, 90, 45, 75, 60, 60, 45, 45, 60, 60, 75
    ]
]
limeteds = [
...
locations = [
    ...
    [  # местности локаций
        'ТЦ МиГ', 'Центральная площадь Максиграда', 'Георгиевская', 'Макеевка', 'Рынок', 'Зоопарк', 'Ботаническая',
