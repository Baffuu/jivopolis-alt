TOKEN = '5171125720:AAHSOP-xDaU5naiCNpdmtJ7yQJ4KETNm6Mg'  #токен бота
...
limeteds = ['bread', 'tea', 'meatcake', 'soup', 'pelmeni', 'meat']  #дефицитные товары #todo rename
...
#команда и калбек для регистрации в Живополисе
createacc = 'создать персонажа'
createacc2 = 'sign_up'

#log chat id
log_chat = -1001762149539
