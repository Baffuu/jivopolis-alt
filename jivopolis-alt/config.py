...
## DEV_TOKEN = '5455856213:AAGDk7JvF2-N_HPZg8vvK7uzuCMy1q7hEoE'  #токен DEV-бота
...
ITEMS = {
        ...
        'palm': ['🌴', 'palm', 'Пальма'],
        'potted_plant': ['🪴', 'potted_plant', 'Комнатное растение'],
        'clover': ['🍀', 'clover', 'Клевер'],
        'tulip': ['🌷', 'tulip', 'Тюльпан'],
        'rose': ['🌹', 'rose', 'Роза'],
        'xmas_tree': ['🎄', 'xmas_tree', 'Новогодняя елка'],
        'moyai': ['🗿', 'moyai', 'Моаи'],
        'chocolate': ['🍫', 'chocolate', 'Плитка шоколада'],
        'shaved_ice': ['🍧', 'shaved_ice', 'Фруктовый лед'],
        'ice_cream': ['🍨', 'ice_cream', 'Мороженое'],
        'stethoscope': ['🩺', 'stethoscope', 'Стетоскоп'],
        'metro': ['🚇', 'metro'],
