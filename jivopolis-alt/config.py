...
ITEMS = {
        ...
        'confetti': ['🎊', 'confetti', 'Конфетти', 50],
        'fireworks': ['🎆', 'fireworks', 'Фейерверки', 75],
        'party_popper': ['🎉', 'party_popper', 'Хлопушка', 50],
        'mrs_claus': ['🤶', 'mrs_claus', 'Миссис Клаус', 75],
        'santa_claus': ['🎅', 'santa_claus', 'Санта Клaус', 100],
        'fairy': ['🧚', 'fairy', 'Фея', 50],
        'snowflake': ['❄️', 'snowflake', 'Снежинка', 30],
        'snowman': ['☃️', 'snowman', 'Снеговик', 50],
        'hedgehog': ['🦔', 'hedgehog', 'Еж', 100],
        'truck': ['🚚', 'truck', 'Грузовик', 3000],
        'gold_medal': ['🥇', 'gold_medal', 'Золотая медаль', -1],
        'silver_medal': ['🥈', 'silver_medal', 'Серебренная медаль', -1],
        'bronze_medal': ['🥉', 'bronze_medal', 'Бронзовая медаль', -1],
        'poison': ['🧪', 'poison', 'Яд', 4000],
        'pill': ['💊', 'pill', 'Таблетка', 500],
        'baguette': ['🥖', 'baguette', 'Багет', 25],
        'milk': ['🥛', 'milk', 'Молоко', 25],
        'ramen': ['🍜', 'ramen', 'Рамен', 25],
        'pelmeni': ['🍲', 'pelmeni', 'Пельмени', 50],
        'apple': ['🍎', 'apple', 'Яблоко', 50],
        'shawarma': ['🌯', 'shawarma', 'Шаурма', 25],
        'burger': ['🍔', 'burger', 'Бургер', 500],
        'pizza': ['🍕', 'pizza', 'Пицца', 200],
        'coconut': ['🥥', 'coconut', 'Кокос', 25],
        'kiwi': ['🥝', 'kiwi', 'Kиви', 10],
        'tomato': ['🍅', 'tomato', 'Помидор', 10], 
        'fries': ['🍟', 'fries', 'Картофель Фри', 10],
        'cucumber': ['🥒', 'cucumber', 'Огурец', 10],
        'spaghetti':['🍝', 'spaghetti', 'Спагетти', 10],
        'doughnut': ['🍩', 'doughnut', 'Пончик', 10],
        'bento': ['🍱', 'bento', 'Бенто', 500],
        'beer': ['🍺', 'beer', 'Пиво', 200],
        'meat_on_bone': ['🍖', 'meat_on_bone', 'Мясо на кости', 200],
        'cheburek': ['🥟', 'cheburek', 'Чeбурек', 50],
        'tea': ['🍵', 'tea', 'Чай', 50],
        'coffee': ['☕', 'coffee', 'Кофе', 50],
        'rice': ['🍚', 'rice', 'Рис', 70],
        'cookie': ['🍪', 'cookie', 'Печенье', 20, ['food', 20], 'cookie'],
        'cake': ['🍰', 'cake', 'Торт', 500],
        'sake': ['🍶', 'sake', 'Саке', 100],
        'pita': ['🥙', 'pita', 'Пита Сэндвич', 200],
        ...
        'juice': ['🥤', 'juice', 'Сок', 100],
        'cactus': ['🌵', 'cactus', 'Кактус', 250],
        'palm': ['🌴', 'palm', 'Пальма', 345],
        'potted_plant': ['🪴', 'potted_plant', 'Комнатное растение',55],
        'clover': ['🍀', 'clover', 'Клевер', 55],
        'tulip': ['🌷', 'tulip', 'Тюльпан', 99],
        'rose': ['🌹', 'rose', 'Роза', 123],
        'xmas_tree': ['🎄', 'xmas_tree', 'Новогодняя елка', 123],
        'moyai': ['🗿', 'moyai', 'Моаи', 123],
        'chocolate': ['🍫', 'chocolate', 'Плитка шоколада', 321],
        'shaved_ice': ['🍧', 'shaved_ice', 'Фруктовый лед', 41],
        'ice_cream': ['🍨', 'ice_cream', 'Мороженое', 569],
        'stethoscope': ['🩺', 'stethoscope', 'Стетоскоп', 444],
        'metro': ['🚇', 'metro'],
        'traintoken': ['🎫', 'traintoken'],
        'phone': ['📱', 'phone'],
        'troleytoken': ['🧾', 'trolleytoken'],
        'hamster': ['🐹', 'hamster'],
    }
