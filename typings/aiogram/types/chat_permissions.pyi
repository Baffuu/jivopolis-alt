...
class ChatPermissions(base.TelegramObject):
    ...
    def __init__(self, can_send_messages: base.Boolean = ..., can_send_media_messages: base.Boolean = ..., can_send_audios: base.Boolean = ..., can_send_documents: base.Boolean = ..., can_send_photos: base.Boolean = ..., can_send_videos: base.Boolean = ..., can_send_video_notes: base.Boolean = ..., can_send_voice_notes: base.Boolean = ..., can_send_polls: base.Boolean = ..., can_send_other_messages: base.Boolean = ..., can_add_web_page_previews: base.Boolean = ..., can_change_info: base.Boolean = ..., can_invite_users: base.Boolean = ..., can_pin_messages: base.Boolean = ..., can_manage_topics: base.Boolean = ..., **kwargs) -> None:
        ...
