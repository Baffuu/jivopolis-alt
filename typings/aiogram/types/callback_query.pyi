...
class CallbackQuery(base.TelegramObject):
    ...
    async def answer(self, text: typing.Optional[base.String] = ..., show_alert: typing.Optional[base.Boolean] = ..., url: typing.Optional[base.String] = ..., cache_time: typing.Optional[base.Integer] = ...): # -> Boolean@answer:
        """
