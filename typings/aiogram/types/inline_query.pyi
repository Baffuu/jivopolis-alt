...
class InlineQuery(base.TelegramObject):
    ...
    query: base.String = ...
    offset: base.String = ...
    chat_type: base.String = ...
    location: Location = ...
    async def answer(self, results: typing.List[InlineQueryResult], cache_time: typing.Optional[base.Integer] = ..., is_personal: typing.Optional[base.Boolean] = ..., next_offset: typing.Optional[base.String] = ..., switch_pm_text: typing.Optional[base.String] = ..., switch_pm_parameter: typing.Optional[base.String] = ...): # -> Boolean@answer_callback_query:
        """
