...
class Chat(base.TelegramObject):
    ...
    async def unpin_all_messages(self): # -> Boolean@answer_callback_query:
        """
    ...
    async def ban_sender_chat(self, sender_chat_id: base.Integer): # -> List[Unknown] | Dict[Unknown, Unknown]:
        """Shortcut for banChatSenderChat method."""
        ...
    
    async def unban_sender_chat(self, sender_chat_id: base.Integer): # -> List[Unknown] | Dict[Unknown, Unknown]:
