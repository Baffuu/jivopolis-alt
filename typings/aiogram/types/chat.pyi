...
from ..utils.deprecated import DeprecatedReadOnlyClassVar, deprecated, removed_argument
...
class Chat(base.TelegramObject):
    ...
    is_forum: base.Boolean = ...
    all_members_are_administrators: base.Boolean = ...
    photo: ChatPhoto = ...
    active_usernames: typing.List[base.String] = ...
    emoji_status_custom_emoji_id: base.String = ...
    bio: base.String = ...
    has_private_forwards: base.Boolean = ...
    has_restricted_voice_and_video_messages: base.Boolean = ...
    join_to_send_messages: base.Boolean = ...
    join_by_request: base.Boolean = ...
    description: base.String = ...
    invite_link: base.String = ...
    pinned_message = ...
    permissions: ChatPermissions = ...
    slow_mode_delay: base.Integer = ...
    message_auto_delete_time: base.Integer = ...
    ...
    has_hidden_members: base.Boolean = ...
    has_aggressive_anti_spam_enabled: base.Boolean = ...
    ...
    async def kick(self, user_id: base.Integer, until_date: typing.Union[base.Integer, datetime.datetime, datetime.timedelta, None] = ..., revoke_messages: typing.Optional[base.Boolean] = ...) -> base.Boolean:
        """
    ...
    async def unpin_all_messages(self) -> base.Booleand:
        """
    ...
    async def do(self, action: base.String, message_thread_id: typing.Optional[base.Integer] = ...) -> base.Boolean:
        """
    ...
    async def create_invite_link(self, expire_date: typing.Union[base.Integer, datetime.datetime, datetime.timedelta, None] = ..., member_limit: typing.Optional[base.Integer] = ..., name: typing.Optional[base.String] = ..., creates_join_request: typing.Optional[base.Boolean] = ...) -> ChatInviteLink:
        """ Shortcut for createChatInviteLink method. """
        ...
    
    async def edit_invite_link(self, invite_link: base.String, expire_date: typing.Union[base.Integer, datetime.datetime, datetime.timedelta, None] = ..., member_limit: typing.Optional[base.Integer] = ..., name: typing.Optional[base.String] = ..., creates_join_request: typing.Optional[base.Boolean] = ...) -> ChatInviteLink:
        """ Shortcut for editChatInviteLink method. """
        ...
    
    async def revoke_invite_link(self, invite_link: base.String) -> ChatInviteLink:
        """ Shortcut for revokeChatInviteLink method. """
        ...
    
    async def delete_message(self, message_id: base.Integer) -> base.Boolean:
        """ Shortcut for deleteMessage method. """
        ...
    
    @removed_argument("until_date", "2.19")
    async def ban_sender_chat(self, sender_chat_id: base.Integer) -> list[typing.Any] | dict[typing.Any, typing.Any]:
        """Shortcut for banChatSenderChat method."""
        ...
    
    async def unban_sender_chat(self, sender_chat_id: base.Integer) -> list[typing.Any] | dict[typing.Any, typing.Any]:
...
class ChatActions(helper.Helper):
    ...
    CHOOSE_STICKER: str = ...
    @classmethod
    def calc_timeout(cls, text, timeout=...) -> float:
        """
